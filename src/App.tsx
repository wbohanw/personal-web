...
import { FaReact, FaPython, FaGitAlt, FaDocker, FaCoffee } from 'react-icons/fa';
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-start">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <a href="https://cafe.bo-han.wang/en" className="w-12 h-12 rounded-full flex items-center justify-center border border-white/30 dark:border-black/30 hover:bg-white/10 dark:hover:bg-black/10 transition-colors duration-300">
